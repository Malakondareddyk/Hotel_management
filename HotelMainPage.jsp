...
<body>
	<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		<div  class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" >Hotel Home Page</a>
			</div>
		</div>
	</nav>	
	<ul id = "menu">
	...
	<div id="myCarousel" class="carousel slide container-fluid" data-ride="carousel">
		...
		<div style = "margin:auto;" class="carousel-inner" role="listbox">
			...
			<div class="item">
				<img src="images/15.jpg" style = "width:100%; height:450px;" />
			</div>
			
			<div class="item">
				<img src="images/16.jpg" style = "width:100%; height:450px;" />
			</div>
			
			<div class="item">
				<img src="images/17.jpg" style = "width:100%; height:450px;" />
			</div>
			
			<div class="item">
				<img src="images/18.jpg" style = "width:100%; height:450px;" />
			</div>
